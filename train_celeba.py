...
parser.add_argument('--name', type=str, default='celeba_attr2sketch2face', help='name of the experiment. It decides where to store samples and models')
...
parser.add_argument('--nt', type=int, default=256, help='#  of dim for image and text features ')
...
parser.add_argument('--lambda_A', type=float, default=50.0, help='weight for L1 loss')
...
face_dataset = CreateDataLoader(opt, csv_fileA='./dataset/celeba/fine_grained_attribute_trainA.txt',root_dirA='./dataset/celeba/trainA/',
                                     csv_fileB='./dataset/celeba/fine_grained_attribute_trainB.txt', root_dirB='./dataset/celeba/trainB/')
