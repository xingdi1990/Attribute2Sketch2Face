...
parser.add_argument('--name', type=str, default='celeba_attr_sketch_face', help='name of the experiment. It decides where to store samples and models')
...
parser.add_argument('--which_epoch', type=str, default='30',
...
parser.add_argument('--manualSeed', type=int, default =000000, help='manual seed')
...
face_dataset = CreateDataLoader(opt, csv_fileA='./dataset/celeba/fine_grained_attribute_testA.txt',root_dirA='./dataset/celeba/testA/',
                                     csv_fileB='./dataset/celeba/fine_grained_attribute_testB.txt', root_dirB='./dataset/celeba/testB/')
